...
//
// ■ 왜 완성값을 넘기는가
// 칸('SlotView')이 "지금 자원 탭인가 캐릭터 탭인가"를 알아보고 분기하면,
...
public readonly struct SlotData
{
    ...
    // 이름 아래 보조 문구 한 줄 — 자원은 수량. 칸 위젯 이름이 'Sub Text'인 것도 이 자리를 가리킨다.
    // ※ 캐릭터는 빈 문자열이다 — 같은 밴드를 적성 스트립이 쓴다(T-048).
    //   문구로 적성 5종을 적으면 19자가 되어 100px 칸에서 글자가 5px까지 줄었다.
