...
> 최종 업데이트: 2026-09-16 (도구 줄 — 정렬 방향 화살표 · 일괄 담기 — T-015 · T-056) · 대상: `Assets/Scripts_Client/UI/Storage/`
...
- 프리팹에 참조를 더하면 **양쪽 화면이 다 영향을 받는다.** 지금 잡아 둔 것은
  `Rarity Image`·`Item Image`·`Name Text`·`Sub Text`·`Aptitude Strip`(+값 5칸)·`Sell Mark`·`Assign Mark`이다.
