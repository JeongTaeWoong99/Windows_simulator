...
namespace GameData
{
    /// <summary>MiningBasicTable 테이블의 한 행. MiningBasicTable.bytes = MemoryPackSerializer.Serialize(List&lt;MiningBasicTableRow&gt;)</summary>
    [MemoryPackable]
    public partial class MiningBasicTableRow
    {
