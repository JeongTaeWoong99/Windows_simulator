...
> 상태: **적성·장비·시작 캐릭터·획득 경로(가챠)·경험치 획득·레벨 곡선·레벨 효과(적성 포인트) 확정**
...
| 6 | **장비 부위 = 무기1 · 장신구2 · 보석1** | 4칸. 효과는 속도식의 **가산** 항 — **대상 산업 지정(None=전 산업) + 가산 천분율.** 장비는 적성을 바꾸지 않는다. 서버 구현 완료(2026-09-17 · T-002) · **정의 69종 입력(2026-09-19)** → 1.3. 획득 경로는 아직 치트뿐이다([T-067](../../../tasks/T-067-장비뽑기.md)) |
...
| 2 | 계정 경험치 전달 비율 · 계정 레벨 곡선 | 3.1 — 원천(`ExpPerJudge`)은 정해졌으니 비율만 남았다 |
