...
> 최종 업데이트: 2026-09-02 · 상태: **3열 배치 · 연출 2레이어 · 위젯 배치·스트립 방향 확정 / 목업 1종(v2)**
...
> 해금 조건 값(T-016)과 해금 판정(T-021)이 정해지면 목업을 갱신한다.
