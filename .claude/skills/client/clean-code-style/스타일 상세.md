...
> 최종 업데이트: 2026-08-26 (Common 자산별 경로 반영) · `SKILL.md` 8장에서 분리
...
(`<스크립트 루트>/Common/center-header/CenterHeaderAttribute.cs` + `<스크립트 루트>/Common/center-header/Editor/CenterHeaderDrawer.cs`.
