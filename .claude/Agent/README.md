...
- [2026-09-24 경매장 서버 — 즉시구매 (T-087)](2026-09-24-auction-server.md) — `#server` `#data` `#test` `#docs` 별도 프로세스 경매장과 메인 연동(잠금·에스크로·우편 정산·outbox·대사)을 구현하고 실측·독립 리뷰까지 반영했다
- [2026-09-23 장비 인챈트 (T-085)](2026-09-23-equip-enchant.md) — `#server` `#data` `#docs` 인챈트 부여·큐브·확장과 속도·경험치 가산을 구현하고 실서버·문서 전파까지 마쳤다
