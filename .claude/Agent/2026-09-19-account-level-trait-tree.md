...
## 업데이트 (2026-09-19) — 실서버 실측
- 더미 클라에 특성 찍기 메뉴 · 배치 산업 레벨 입력 · 가챠 3~5 · 치트 8·9 안내를 추가했다.
- 실서버 왕복으로 특성 거절 3종 · 성공 · 재로그인 복원 · Lv2 배치/Lv3 거절 · Lv2 드롭 · 경험치 1:1 · 속도 +10% · 장비 뽑기 3풀을 확인했다.
- 시험 계정(`live-t021`)이 남은 `game.sqlite3`는 테스트 직전 백업으로 되돌렸다 — 커밋된 스키마와 같다.
